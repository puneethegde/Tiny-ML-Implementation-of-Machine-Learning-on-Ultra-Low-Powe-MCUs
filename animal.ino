...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(
  ...
  <style>
    body{
background-image:linear-gradient(rgba(230, 185, 185, 0),rgb(215, 159, 230));
height: 100vh;
color: rgb(16, 22, 27);
box-shadow:5px;
}
...
#object,#score,#mirrorimage,#framesize,#rotate{
    background-color: rgba(178, 127, 207, 0.705);
    padding: 5%;
}
#getStill,#restart{
    background-color: rgba(221, 17, 228, 0.329);
...
footer{
  ...
  <center>
  <body>
    <h1>B10 PROJECT BATCH</h1>
    <h2>Implementation of TinyML in ultra low power MCU's  </h2>
  ...
  <tr>
    <td>Rotate</td>
    <td class="rotate" align="left" colspan="2">
  ...
  <footer>Nitte Meenakshi Institute of Technology</footer>
...
String sendCapturedImageToLineNotify(String token) 
{
  ...
  if (client_tcp.connect("notify-api.line.me", 443)) {
    ...
    String message = "Welcome to B10 batch.";
